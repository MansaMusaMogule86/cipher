...
const DEBUG_SECTIONS = [
  ...
  { href: '/debug/ai', label: 'AI Router', desc: 'Test Anthropic/OpenRouter tiers, streaming, costs' },
  { href: '/debug/stripe', label: 'Stripe & Payments', desc: 'Test checkout sessions, webhooks, crypto' },
